...
<div class="container mt-5" style="max-width: 1200px;">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <h1>
                <i class="fas fa-gavel"></i> Dispute Review #<?php echo $disputeId; ?>
            </h1>
            <p class="text-muted">Detailed dispute review and resolution interface</p>
        </div>
        <div class="col-md-4 text-end">
            <a href="/admin/disputes_list.php" class="btn btn-secondary">
